...
exports.getAllfromData = `SELECT * from disrepency order by Discrepency_ID;`
...
exports.updateProperStatus= `update disrepency set Description = 'exists in stripe only' , Status='new' where FD_Amount IS NULL and Stripe_Amount IS NOT NULL and Stripe_charge_id IS NOT NULL;`
